          ...
          <div class="box box-info">
                <div class="box box-info">
                              ...
                              <div class="box-body">
                                  <div class="container" style="width: auto;">
                                      <div class="form-group">
                                          <h4>Perubahan APBDesa Tahun {{$data->tahun_apbd}}</h4>
                                          <table>
                                          <tr>
                                        ...
                                        <br>
                                            ...
                                            {!! Form::button('Konfirmasi Perubahan APBDesa', array('type'=>'submit','class'=>'btn btn-xs btn-success form-control konfirmasi', 'rel'=>'tooltip', 'title'=>'konfirmasi')) !!}
                                            {!! Form::close() !!} 
                                      </div>
                                  </div>
                  <div class="box-header with-border"><h3 class="box-title" style="margin-left: 15px;margin-bottom: 5px;" >Pendapatan Tahun {{$data->tahun_apbd}}</h3>
                      <td><a href="/admin/menupelaporan/{{$data->id}}/papbdesa/pendapatan" class="btn btn-xs btn-success fa fa-plus"  title="tambah" style="position:absolute;right:20px;"></a></td>
                    </div>
                        <div class="box-body">
                            <div class="container" style="width: auto;">
                                <div class="form-group">
