                              ...
                              <div class="container" style="width: auto;">
                                  <div class="form-group">
                                    ...
                                    <br>
                                        ...
                                        {!! Form::model($data,['route'=>['admin.pelaporan.pembatalan', $data->id,],'method'=>'POST']) !!}
                                        {!! Form::button('Batalkan APBDesa', array('type'=>'submit','class'=>'btn btn-xs btn-success form-control pembatalan', 'rel'=>'tooltip', 'title'=>'konfirmasi')) !!}
                                        {!! Form::close() !!} 
                                  </div>
                              </div>
<br>
...
<script>$(document).ready(function() {
    ...
    <script>    
            $('.pembatalan').on('click', function(e) {
                ...
                e.preventDefault();
                swal({
                    title: "Apakah Anda yakin untuk membatalkan APBDesa ini?",
